...
module bd_38aa
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXIS:SLOT_2_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN cpu_system_mig_7series_0_0_ui_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0" *) input clk;
  ...
  bd_38aa_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe29(net_slot_2_axis_tdata),
        .probe3(net_slot_0_axi_arlen),
        .probe30(net_slot_2_axis_tkeep),
        .probe31(net_slot_2_axis_tvalid),
        .probe32(net_slot_2_axis_tready),
        .probe33(net_slot_2_axis_tlast),
