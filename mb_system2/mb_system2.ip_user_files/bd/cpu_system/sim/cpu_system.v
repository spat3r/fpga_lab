...
(* CORE_GENERATION_INFO = "cpu_system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=cpu_system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=24,numReposBlks=16,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_mb_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "cpu_system.hwdef" *) 
module cpu_system
   (btn_tri_i,
    clk_in,
    disp_tri_o,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_IN CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_IN, CLK_DOMAIN cpu_system_clk_in1_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_in;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 disp TRI_O" *) output [11:0]disp_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 led TRI_O" *) output [23:0]led_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.RSTBT RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.RSTBT, INSERT_VIP 0, POLARITY ACTIVE_HIGH" *) input rstbt;
  input [7:0]sw;
  ...
  wire [11:0]gpio_led_disp_GPIO2_TRI_O;
  wire [23:0]gpio_led_disp_GPIO_TRI_O;
  wire [3:0]gpio_sw_btn_GPIO2_TRI_I;
  wire gpio_sw_btn_ip2intc_irpt;
  ...
  wire uartlite_interrupt;

  assign clk_in1_0_1 = clk_in;
  assign disp_tri_o[11:0] = gpio_led_disp_GPIO2_TRI_O;
  assign gpio_io_i_0_1 = sw[7:0];
  assign gpio_sw_btn_GPIO2_TRI_I = btn_tri_i[3:0];
  assign led_tri_o[23:0] = gpio_led_disp_GPIO_TRI_O;
  assign reset_0_1 = rstbt;
  assign uart_txd = uartlite_UART_TxD;
  assign uartlite_UART_RxD = uart_rxd;
  cpu_system_clk_wiz_1_0 clk_wiz_1
       (.clk_in1(clk_in1_0_1),
        .clk_out1(microblaze_0_Clk),
        .locked(clk_wiz_1_locked),
        .reset(reset_0_1));
  cpu_system_axi_gpio_0_0 gpio_led_disp
       (.gpio2_io_o(gpio_led_disp_GPIO2_TRI_O),
        .gpio_io_o(gpio_led_disp_GPIO_TRI_O),
  ...
  cpu_system_axi_gpio_1_0 gpio_sw_btn
       (.gpio2_io_i(gpio_sw_btn_GPIO2_TRI_I),
        .gpio_io_i(gpio_io_i_0_1),
        .ip2intc_irpt(gpio_sw_btn_ip2intc_irpt),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  cpu_system_microblaze_0_axi_intc_0 microblaze_0_axi_intc
  ...
  cpu_system_microblaze_0_xlconcat_0 microblaze_0_xlconcat
       (.In0(timer_interrupt),
        .In1(uartlite_interrupt),
        .In2(gpio_sw_btn_ip2intc_irpt),
        .dout(microblaze_0_intr));
  cpu_system_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
  ...
  cpu_system_axi_timer_0_0 timer
       (.capturetrig0(1'b0),
        .capturetrig1(1'b0),
        .freeze(1'b0),
  ...
  cpu_system_axi_uartlite_0_0 uartlite
       (.interrupt(uartlite_interrupt),
...
module cpu_system_microblaze_0_axi_periph_0
  ...
  m03_couplers_imp_87EROZ m03_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  m04_couplers_imp_1Y5KMJK m04_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
...
module m03_couplers_imp_87EROZ
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m04_couplers_imp_1Y5KMJK
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
