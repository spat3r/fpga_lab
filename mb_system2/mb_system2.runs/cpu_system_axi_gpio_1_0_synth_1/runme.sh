...
HD_PWD='E:/Egyetem/fpga_alapu_rendszerek/mb_system2/mb_system2.runs/cpu_system_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_system_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_system_axi_gpio_1_0.tcl
